...
/**
 * Created by：LiXueLong 李雪龙 on 17-6-30 下午3:08
 * <p>
 * Mail : skylarklxlong@outlook.com
 * <p>
 * Description:
 */
public class KSoap2WebServiceUtils {
    private final String namespace;
    private final String serviceURL;
    private final KSoap2WebServiceDelegate delegate;

    public KSoap2WebServiceUtils(String namespace, String serviceURL,
                                 KSoap2WebServiceDelegate delegate) {
        super();
